"""
此脚本用于输出精排模型后，rank在前三位但是不在第一位的query及其前五个candidates
"""
import argparse
import json
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_file', default='data/simCLUE_train.json',
                        help='train file')
    parser.add_argument('--test_file', default='/data1/wtc/HW-QA/fasttext_train_label.json',
                        help='test file')
    ...
    with open('/data1/wtc/HW-QA/case_study_top3.json', mode='w+', encoding='utf-8') as f:
